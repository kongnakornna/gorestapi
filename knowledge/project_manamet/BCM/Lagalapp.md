...
```mermaid
flowchart TB
    Start(["เริ่ม: สินค้าเสียหายเมื่อถึงปลายทาง"]) --> Step1["แจ้งเหตุต่อผู้ขนส่ง/ตัวแทน\nและจัดทำรายงานการตรวจสภาพ (Survey Report)"]
    Step1 --> Step2["เก็บหลักฐาน:\n- ใบตราส่ง (Bill of Lading)\n- ใบส่งของ/ใบกำกับสินค้า\n- ภาพถ่ายความเสียหาย"]
    Step2 --> Step3["ตรวจสอบสัญญา/กฎหมายที่ใช้บังคับ\nเช่น CISG, Hague-Visby Rules"]
...
### 1.4 การฟ้องคดีแบบกลุ่ม (Class Action – รถโดยสารแก๊สระเบิด)
 ...
 <img width="1936" height="7455" alt="ca2" src="https://github.com/user-attachments/assets/ca9717cc-4ec2-41ea-a9a4-5f3bd0001df5" />
