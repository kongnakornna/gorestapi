...
```mermaid
flowchart TB
    Start([เริ่ม: โจทก์พบการละเมิดลิขสิทธิ์]) --> Step1

    subgraph Step1 [รวบรวมพยานหลักฐาน]
        direction LR
        A1["เอกสารจดทะเบียนลิขสิทธิ์"]
        A2["หลักฐานการทำซ้ำ/เผยแพร่"]
        A3["พยานบุคคล"]
    end

    Step1 --> Decision{แจ้งความดำเนินคดีอาญา?}

    Decision -->|ใช่| Step3[แจ้งความต่อพนักงานสอบสวน]
    Step3 --> Step4[พนักงานสอบสวนส่งสำนวนให้อัยการ]
    Step4 --> Step5[อัยการยื่นฟ้องคดีอาญาต่อศาล IP]

    Decision -->|ไม่| Step6[ยื่นฟ้องคดีแพ่งโดยตรง]
    Step5 --> Step6

    Step6 --> Step7[ยื่นคำฟ้องคดีแพ่ง พร้อมแนบเอกสาร]
    ...
    Step17 --> Step18{พอใจ?}
    Step18 -->|ใช่| End2
    Step18 -->|ไม่| Step19[ฎีกาต่อศาลฎีกาแผนก IP]
...
flowchart TB
    ...
    Step4 --> Step5{ผู้ขนส่งตอบรับหรือปฏิเสธ?}
