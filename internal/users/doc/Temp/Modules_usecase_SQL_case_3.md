...
func (r *UserPgRepo) GetUsersWithRanking(ctx context.Context) ([]UserWithRank, error) {
...
func (r *UserPgRepo) GetTopNPerGroup(ctx context.Context, n int) ([]UserWithGroupRank, error) {
...
func (r *UserPgRepo) GetUserScoreComparison(ctx context.Context) ([]UserComparison, error) {
...
func (r *UserPgRepo) GetRunningTotal(ctx context.Context) ([]UserRunningTotal, error) {
...
func (r *UserPgRepo) GetUsersByJSONCondition(ctx context.Context, key, value string) ([]models.User, error) {
    var users []models.User
...
func (r *UserPgRepo) GetUsersWithTag(ctx context.Context, tag string) ([]models.User, error) {
    var users []models.User
...
func (r *UserPgRepo) UpdateJSONField(ctx context.Context, userID uint, path string, value interface{}) error {
...
func (r *UserPgRepo) AggregateJSONData(ctx context.Context, roleID int) (map[string]interface{}, error) {
    var result struct {
...
func (r *UserPgRepo) SearchInJSON(ctx context.Context, searchText string) ([]models.User, error) {
    var users []models.User
...
func (s *UserRepoTestSuite) SetupTest() {
    // สร้าง test database
    s.db = setupTestDB()
    s.repo = repositories.NewUserPgRepo(s.db)
...
func BenchmarkFilterUsers(b *testing.B) {
    db := setupTestDB()
    repo := repositories.NewUserPgRepo(db)
