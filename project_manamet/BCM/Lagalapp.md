...
```mermaid
flowchart TB
    Start([เริ่ม: ผู้เสียหายจำนวนมาก<br>ประเด็นเดียวกัน]) --> A[รวมกลุ่มผู้เสียหาย<br>หาตัวแทนกลุ่ม (Lead Plaintiff)]
    A --> B[ยื่นคำร้องขอให้ดำเนินคดีแบบกลุ่ม<br>ต่อศาลแพ่ง]
    B --> C[ศาลไต่สวนคำร้อง]
    C --> D{ศาลวินิจฉัย}

    D -- ไม่รับคำร้อง --> E[ดำเนินคดีเป็นรายบุคคล]
    E --> End1([สิ้นสุด])

    D -- รับคำร้อง --> F[ศาลมีคำสั่งอนุญาต]
    F --> G[ศาลกำหนดวิธีการแจ้งสมาชิกกลุ่ม]
    G --> H[ประกาศแจ้งสมาชิกกลุ่มทางหนังสือพิมพ์/สื่อ]
    ...
    N --> O{มีอุทธรณ์/ฎีกา?}
    O -- ใช่ --> P[โจทก์ตัวแทนยื่นอุทธรณ์/ฎีกา<br>ในนามสมาชิกกลุ่ม]
    P --> Q[ศาลอุทธรณ์/ฎีกาพิพากษา]
    Q --> R[คำพิพากษาผูกพันสมาชิกกลุ่ม<br>ที่ไม่ได้ Opt-out]

    O -- ไม่ --> R

    R --> S{โจทก์ชนะ?}
    S -- ใช่ --> T[กำหนดวิธีการชำระค่าเสียหาย]
    T --> U[ศาลแต่งตั้งผู้จัดการ/กรรมการ<br>จัดสรรเงินให้สมาชิก]
